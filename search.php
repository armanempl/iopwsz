...
<html lang="en">
   <head>
      ...
      <title>Literatura szkolna - Księgarnia iBook</title>
            ...
            <?php 
               ...
               try{
                  ...
                  if($connection-> connect_errno != 0){
                    ...
                    if($query = mysqli_query($connection, "Select * From asortyment where tytul LIKE '%$search%' ORDER BY tytul;")){
                      if($query->num_rows > 0){
                        $row = $query->fetch_assoc();
                        $ile = $query->num_rows;
                        for($i = 0 ; $i < $ile ; $i++){
                           if($query2 = mysqli_query($connection, "Select * From asortyment where tytul LIKE '%$search%' ORDER BY tytul;")){
